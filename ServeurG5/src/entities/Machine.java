...
@Entity
@Table(name = "machines")
@NamedQuery(name = "findMachineParSalle", query = "from Machine m WHERE m.salle = :salle")
@NamedNativeQuery(name = "findAllMachineNative", query = "select * from machines", resultClass = Machine.class)
